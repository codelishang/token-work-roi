...
The collectors extract and store only structured fields needed for token usage analysis. They do not store prompts, responses, full conversations, diffs, or command bodies. Some collectors may keep a workspace or project path in the local SQLite database for project attribution; this data is not uploaded by default.
