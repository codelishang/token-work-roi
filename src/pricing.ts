...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    model: "glm-5.2",
    aliases: ["glm-5-2"],
    input: 1.1825752853295475,
    cachedInput: 0.29564382133238687,
    cacheWrite5m: 1.1825752853295475,
    cacheWrite1h: 1.1825752853295475,
    output: 4.139013498653416,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":8,"output":28,"cachedInput":2,"cacheWrite5m":8,"cacheWrite1h":8},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-5.1",
    aliases: ["glm-5-1"],
    input: 0.8869314639971606,
    cachedInput: 0.19216848386605145,
    cacheWrite5m: 0.8869314639971606,
    cacheWrite1h: 0.8869314639971606,
    output: 3.5477258559886424,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":24,"cachedInput":1.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-4.5-air",
    aliases: ["glm-4-5-air"],
    input: 0.11825752853295475,
    cachedInput: 0.02365150570659095,
    cacheWrite5m: 0.11825752853295475,
    cacheWrite1h: 0.11825752853295475,
    output: 0.29564382133238687,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2,"cachedInput":0.16,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-4.7",
    aliases: ["glm-4-7"],
    input: 0.29564382133238687,
    cachedInput: 0.059128764266477375,
    cacheWrite5m: 0.29564382133238687,
    cacheWrite1h: 0.29564382133238687,
    output: 1.1825752853295475,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5912876426647737,
    cachedInput: 0.14782191066619343,
    cacheWrite5m: 0.5912876426647737,
    cacheWrite1h: 0.5912876426647737,
    output: 2.6607943919914816,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":18,"cachedInput":1,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7391095533309672,
    cachedInput: 0.1773862927994321,
    cacheWrite5m: 0.7391095533309672,
    cacheWrite1h: 0.7391095533309672,
    output: 3.2520820346562553,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":5,"output":22,"cachedInput":1.2,"cacheWrite5m":5,"cacheWrite1h":5},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 4.434657319985803,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":30,"cachedInput":1.2,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    input: 0.4434657319985803,
    cachedInput: 0.08869314639971605,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.2173286599929014,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3,"output":15,"cachedInput":0.6,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark CNY online-inference rate converted to USD at the last verified refresh rate. Cache-storage charges are not included."
  }),
  officialRate({
  ...
  officialRate({
    ...
    model: "kimi-k3",
    aliases: ["kimi-k3"],
    input: 2.9564382133238687,
    cachedInput: 0.29564382133238687,
    cacheWrite5m: 2.9564382133238687,
    cacheWrite1h: 2.9564382133238687,
    output: 14.782191066619344,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":20,"cachedInput":2,"cacheWrite5m":20,"cacheWrite1h":20,"output":100},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
  ...
  officialRate({
    ...
    input: 0.9608424193302573,
    cachedInput: 0.19216848386605145,
    cacheWrite5m: 0.9608424193302573,
    cacheWrite1h: 0.9608424193302573,
    output: 3.9911915879872226,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.3,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.9216848386605145,
    cachedInput: 0.3843369677321029,
    cacheWrite5m: 1.9216848386605145,
    cacheWrite1h: 1.9216848386605145,
    output: 7.982383175974445,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":13,"cachedInput":2.6,"cacheWrite5m":13,"cacheWrite1h":13,"output":54},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-6"],
    input: 0.9608424193302573,
    cachedInput: 0.16260410173281278,
    cacheWrite5m: 0.9608424193302573,
    cacheWrite1h: 0.9608424193302573,
    output: 3.9911915879872226,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.1,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-5"],
    input: 0.5912876426647737,
    cachedInput: 0.1034753374663354,
    cacheWrite5m: 0.5912876426647737,
    cacheWrite1h: 0.5912876426647737,
    output: 3.1042601239900622,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"cachedInput":0.7,"cacheWrite5m":4,"cacheWrite1h":4,"output":21},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    cacheWrite1h: 0.29564382133238687,
    output: 1.1825752853295475,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    model: "qwen3.7-max",
    aliases: ["qwen3-7-max"],
    input: 1.7738629279943212,
    cachedInput: 1.7738629279943212,
    cacheWrite5m: 1.7738629279943212,
    cacheWrite1h: 1.7738629279943212,
    output: 5.321588783982963,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":12,"output":36,"cachedInput":12,"cacheWrite5m":12,"cacheWrite1h":12},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.1773862927994321,
    cachedInput: 0.1773862927994321,
    cacheWrite5m: 0.1773862927994321,
    cacheWrite1h: 0.1773862927994321,
    output: 1.0643177567965927,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1.2,"output":7.2,"cachedInput":1.2,"cacheWrite5m":1.2,"cacheWrite1h":1.2},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5912876426647737,
    cachedInput: 0.5912876426647737,
    cacheWrite5m: 0.5912876426647737,
    cacheWrite1h: 0.5912876426647737,
    output: 2.365150570659095,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":16,"cachedInput":4,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.14782191066619343,
    cachedInput: 0.14782191066619343,
    cacheWrite5m: 0.14782191066619343,
    cacheWrite1h: 0.14782191066619343,
    output: 0.5912876426647737,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":1,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB short-context Coder rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.517376687331677,
    cachedInput: 0.517376687331677,
    cacheWrite5m: 0.517376687331677,
    cacheWrite1h: 0.517376687331677,
    output: 1.034753374663354,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.5,"output":7,"cachedInput":3.5,"cacheWrite5m":3.5,"cacheWrite1h":3.5},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite5m: 0.29564382133238687,
    cacheWrite1h: 0.29564382133238687,
    output: 0.8869314639971606,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.764897,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB Coder rate converted to USD at the last verified refresh rate."
  })
];
