...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    model: "glm-5.2",
    aliases: ["glm-5-2"],
    input: 1.1847793763084407,
    cachedInput: 0.29619484407711016,
    cacheWrite5m: 1.1847793763084407,
    cacheWrite1h: 1.1847793763084407,
    output: 4.146727817079543,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":8,"output":28,"cachedInput":2,"cacheWrite5m":8,"cacheWrite1h":8},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-5.1",
    aliases: ["glm-5-1"],
    input: 0.8885845322313306,
    cachedInput: 0.19252664865012162,
    cacheWrite5m: 0.8885845322313306,
    cacheWrite1h: 0.8885845322313306,
    output: 3.5543381289253224,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":24,"cachedInput":1.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-4.5-air",
    aliases: ["glm-4-5-air"],
    input: 0.11847793763084408,
    cachedInput: 0.023695587526168814,
    cacheWrite5m: 0.11847793763084408,
    cacheWrite1h: 0.11847793763084408,
    output: 0.29619484407711016,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2,"cachedInput":0.16,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-4.7",
    aliases: ["glm-4-7"],
    input: 0.29619484407711016,
    cachedInput: 0.05923896881542204,
    cacheWrite5m: 0.29619484407711016,
    cacheWrite1h: 0.29619484407711016,
    output: 1.1847793763084407,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5923896881542203,
    cachedInput: 0.14809742203855508,
    cacheWrite5m: 0.5923896881542203,
    cacheWrite1h: 0.5923896881542203,
    output: 2.6657535966939916,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":18,"cachedInput":1,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7404871101927755,
    cachedInput: 0.17771690644626612,
    cacheWrite5m: 0.7404871101927755,
    cacheWrite1h: 0.7404871101927755,
    output: 3.258143284848212,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":5,"output":22,"cachedInput":1.2,"cacheWrite5m":5,"cacheWrite1h":5},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 4.442922661156653,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":30,"cachedInput":1.2,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    input: 0.4442922661156653,
    cachedInput: 0.08885845322313306,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.2214613305783266,
  ...
  officialRate({
    ...
    model: "kimi-k3",
    aliases: ["kimi-k3"],
    input: 2.961948440771102,
    cachedInput: 0.29619484407711016,
    cacheWrite5m: 2.961948440771102,
    cacheWrite1h: 2.961948440771102,
    output: 14.80974220385551,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":20,"cachedInput":2,"cacheWrite5m":20,"cacheWrite1h":20,"output":100},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
  ...
  officialRate({
    ...
    input: 0.9626332432506081,
    cachedInput: 0.19252664865012162,
    cacheWrite5m: 0.9626332432506081,
    cacheWrite1h: 0.9626332432506081,
    output: 3.9986303950409874,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.3,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.9252664865012161,
    cachedInput: 0.38505329730024324,
    cacheWrite5m: 1.9252664865012161,
    cacheWrite1h: 1.9252664865012161,
    output: 7.997260790081975,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":13,"cachedInput":2.6,"cacheWrite5m":13,"cacheWrite1h":13,"output":54},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-6"],
    input: 0.9626332432506081,
    cachedInput: 0.1629071642424106,
    cacheWrite5m: 0.9626332432506081,
    cacheWrite1h: 0.9626332432506081,
    output: 3.9986303950409874,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.1,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-5"],
    input: 0.5923896881542203,
    cachedInput: 0.10366819542698856,
    cacheWrite5m: 0.5923896881542203,
    cacheWrite1h: 0.5923896881542203,
    output: 3.110045862809657,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"cachedInput":0.7,"cacheWrite5m":4,"cacheWrite1h":4,"output":21},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    cacheWrite1h: 0.29619484407711016,
    output: 1.1847793763084407,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    model: "qwen3.7-max",
    aliases: ["qwen3-7-max"],
    input: 1.7771690644626612,
    cachedInput: 1.7771690644626612,
    cacheWrite5m: 1.7771690644626612,
    cacheWrite1h: 1.7771690644626612,
    output: 5.331507193387983,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":12,"output":36,"cachedInput":12,"cacheWrite5m":12,"cacheWrite1h":12},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.17771690644626612,
    cachedInput: 0.17771690644626612,
    cacheWrite5m: 0.17771690644626612,
    cacheWrite1h: 0.17771690644626612,
    output: 1.0663014386775966,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1.2,"output":7.2,"cachedInput":1.2,"cacheWrite5m":1.2,"cacheWrite1h":1.2},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5923896881542203,
    cachedInput: 0.5923896881542203,
    cacheWrite5m: 0.5923896881542203,
    cacheWrite1h: 0.5923896881542203,
    output: 2.3695587526168813,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":16,"cachedInput":4,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.14809742203855508,
    cachedInput: 0.14809742203855508,
    cacheWrite5m: 0.14809742203855508,
    cacheWrite1h: 0.14809742203855508,
    output: 0.5923896881542203,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":1,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB short-context Coder rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5183409771349429,
    cachedInput: 0.5183409771349429,
    cacheWrite5m: 0.5183409771349429,
    cacheWrite1h: 0.5183409771349429,
    output: 1.0366819542698857,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.5,"output":7,"cachedInput":3.5,"cacheWrite5m":3.5,"cacheWrite1h":3.5},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite5m: 0.29619484407711016,
    cacheWrite1h: 0.29619484407711016,
    output: 0.8885845322313306,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.752312,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB Coder rate converted to USD at the last verified refresh rate."
  })
];
