...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    model: "glm-5.2",
    aliases: ["glm-5-2"],
    input: 1.1803358409568274,
    cachedInput: 0.29508396023920686,
    cacheWrite5m: 1.1803358409568274,
    cacheWrite1h: 1.1803358409568274,
    output: 4.131175443348896,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":8,"output":28,"cachedInput":2,"cacheWrite5m":8,"cacheWrite1h":8},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-5.1",
    aliases: ["glm-5-1"],
    input: 0.8852518807176205,
    cachedInput: 0.19180457415548446,
    cacheWrite5m: 0.8852518807176205,
    cacheWrite1h: 0.8852518807176205,
    output: 3.541007522870482,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":24,"cachedInput":1.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-4.5-air",
    aliases: ["glm-4-5-air"],
    input: 0.11803358409568275,
    cachedInput: 0.023606716819136547,
    cacheWrite5m: 0.11803358409568275,
    cacheWrite1h: 0.11803358409568275,
    output: 0.29508396023920686,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2,"cachedInput":0.16,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-4.7",
    aliases: ["glm-4-7"],
    input: 0.29508396023920686,
    cachedInput: 0.059016792047841375,
    cacheWrite5m: 0.29508396023920686,
    cacheWrite1h: 0.29508396023920686,
    output: 1.1803358409568274,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5901679204784137,
    cachedInput: 0.14754198011960343,
    cacheWrite5m: 0.5901679204784137,
    cacheWrite1h: 0.5901679204784137,
    output: 2.6557556421528616,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":18,"cachedInput":1,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7377099005980171,
    cachedInput: 0.1770503761435241,
    cacheWrite5m: 0.7377099005980171,
    cacheWrite1h: 0.7377099005980171,
    output: 3.2459235626312752,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":5,"output":22,"cachedInput":1.2,"cacheWrite5m":5,"cacheWrite1h":5},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 4.426259403588102,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":30,"cachedInput":1.2,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    input: 0.44262594035881025,
    cachedInput: 0.08852518807176205,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.213129701794051,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3,"output":15,"cachedInput":0.6,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark CNY online-inference rate converted to USD at the last verified refresh rate. Cache-storage charges are not included."
  }),
  officialRate({
  ...
  officialRate({
    ...
    model: "kimi-k3",
    aliases: ["kimi-k3"],
    input: 2.9508396023920684,
    cachedInput: 0.29508396023920686,
    cacheWrite5m: 2.9508396023920684,
    cacheWrite1h: 2.9508396023920684,
    output: 14.754198011960343,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":20,"cachedInput":2,"cacheWrite5m":20,"cacheWrite1h":20,"output":100},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
  ...
  officialRate({
    ...
    input: 0.9590228707774222,
    cachedInput: 0.19180457415548446,
    cacheWrite5m: 0.9590228707774222,
    cacheWrite1h: 0.9590228707774222,
    output: 3.9836334632292925,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.3,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.9180457415548444,
    cachedInput: 0.38360914831096893,
    cacheWrite5m: 1.9180457415548444,
    cacheWrite1h: 1.9180457415548444,
    output: 7.967266926458585,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":13,"cachedInput":2.6,"cacheWrite5m":13,"cacheWrite1h":13,"output":54},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-6"],
    input: 0.9590228707774222,
    cachedInput: 0.16229617813156377,
    cacheWrite5m: 0.9590228707774222,
    cacheWrite1h: 0.9590228707774222,
    output: 3.9836334632292925,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.1,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-5"],
    input: 0.5901679204784137,
    cachedInput: 0.10327938608372239,
    cacheWrite5m: 0.5901679204784137,
    cacheWrite1h: 0.5901679204784137,
    output: 3.098381582511672,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"cachedInput":0.7,"cacheWrite5m":4,"cacheWrite1h":4,"output":21},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    cacheWrite1h: 0.29508396023920686,
    output: 1.1803358409568274,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    model: "qwen3.7-max",
    aliases: ["qwen3-7-max"],
    input: 1.770503761435241,
    cachedInput: 1.770503761435241,
    cacheWrite5m: 1.770503761435241,
    cacheWrite1h: 1.770503761435241,
    output: 5.311511284305723,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":12,"output":36,"cachedInput":12,"cacheWrite5m":12,"cacheWrite1h":12},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.1770503761435241,
    cachedInput: 0.1770503761435241,
    cacheWrite5m: 0.1770503761435241,
    cacheWrite1h: 0.1770503761435241,
    output: 1.0623022568611447,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1.2,"output":7.2,"cachedInput":1.2,"cacheWrite5m":1.2,"cacheWrite1h":1.2},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5901679204784137,
    cachedInput: 0.5901679204784137,
    cacheWrite5m: 0.5901679204784137,
    cacheWrite1h: 0.5901679204784137,
    output: 2.360671681913655,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":16,"cachedInput":4,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.14754198011960343,
    cachedInput: 0.14754198011960343,
    cacheWrite5m: 0.14754198011960343,
    cacheWrite1h: 0.14754198011960343,
    output: 0.5901679204784137,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":1,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB short-context Coder rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.516396930418612,
    cachedInput: 0.516396930418612,
    cacheWrite5m: 0.516396930418612,
    cacheWrite1h: 0.516396930418612,
    output: 1.032793860837224,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.5,"output":7,"cachedInput":3.5,"cacheWrite5m":3.5,"cacheWrite1h":3.5},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite5m: 0.29508396023920686,
    cacheWrite1h: 0.29508396023920686,
    output: 0.8852518807176205,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.777732,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB Coder rate converted to USD at the last verified refresh rate."
  })
];
