...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    input: 0.6235598736251989,
    cachedInput: 0.6235598736251989,
    cacheWrite5m: 0.6235598736251989,
    cacheWrite1h: 0.6235598736251989,
    output: 2.4942394945007957,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4.2,"output":16.8,"cachedInput":4.2,"cacheWrite5m":4.2,"cacheWrite1h":4.2},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.1484666365774283,
    cachedInput: 0.03711665914435708,
    cacheWrite5m: 0.1484666365774283,
    cacheWrite1h: 0.1484666365774283,
    output: 0.5938665463097133,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":0.25,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
  ...
  officialRate({
    ...
    input: 0.8907998194645699,
    cachedInput: 0.04453999097322849,
    cacheWrite5m: 0.8907998194645699,
    cacheWrite1h: 0.8907998194645699,
    output: 2.6723994583937096,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":18,"cachedInput":0.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Tencent Hunyuan",
  ...
  officialRate({
    ...
    model: "glm-5.3",
    aliases: ["glm-5-3"],
    input: 1.1877330926194265,
    cachedInput: 0.2969332731548566,
    cacheWrite5m: 1.1877330926194265,
    cacheWrite1h: 1.1877330926194265,
    output: 4.157065824167993,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":8,"output":28,"cachedInput":2,"cacheWrite5m":8,"cacheWrite1h":8},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.05938665463097133,
    cachedInput: 0.017073663206404258,
    cacheWrite5m: 0.05938665463097133,
    cacheWrite1h: 0.05938665463097133,
    output: 0.20785329120839963,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.4,"output":1.4,"cachedInput":0.115,"cacheWrite5m":0.4,"cacheWrite1h":0.4},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    aliases: ["glm-5-1"],
    input: 0.8907998194645699,
    cachedInput: 0.1930066275506568,
    cacheWrite5m: 0.8907998194645699,
    cacheWrite1h: 0.8907998194645699,
    output: 3.5631992778582795,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":24,"cachedInput":1.3,"cacheWrite5m":6,"cacheWrite1h":6},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    model: "glm-4.5-air",
    aliases: ["glm-4-5-air"],
    input: 0.11877330926194266,
    cachedInput: 0.02375466185238853,
    cacheWrite5m: 0.11877330926194266,
    cacheWrite1h: 0.11877330926194266,
    output: 0.2969332731548566,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.8,"output":2,"cachedInput":0.16,"cacheWrite5m":0.8,"cacheWrite1h":0.8},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-4.7",
    aliases: ["glm-4-7"],
    input: 0.2969332731548566,
    cachedInput: 0.05938665463097133,
    cacheWrite5m: 0.2969332731548566,
    cacheWrite1h: 0.2969332731548566,
    output: 1.1877330926194265,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":0.4,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5938665463097133,
    cachedInput: 0.1484666365774283,
    cacheWrite5m: 0.5938665463097133,
    cacheWrite1h: 0.5938665463097133,
    output: 2.6723994583937096,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":18,"cachedInput":1,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7423331828871416,
    cachedInput: 0.17815996389291397,
    cacheWrite5m: 0.7423331828871416,
    cacheWrite1h: 0.7423331828871416,
    output: 3.266266004703423,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":5,"output":22,"cachedInput":1.2,"cacheWrite5m":5,"cacheWrite1h":5},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
  ...
  officialRate({
    ...
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 4.45399909732285,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6,"output":30,"cachedInput":1.2,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    input: 0.44539990973228494,
    cachedInput: 0.08907998194645698,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 2.226999548661425,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3,"output":15,"cachedInput":0.6,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
    note: "Official Volcengine Ark CNY online-inference rate converted to USD at the last verified refresh rate. Cache-storage charges are not included."
  }),
  officialRate({
    ...
    input: 0.08907998194645698,
    cachedInput: 0.0178159963892914,
    cacheWrite5m: 0,
    cacheWrite1h: 0,
    output: 0.534479891678742,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":0.6,"output":3.6,"cachedInput":0.12,"cacheWrite5m":0,"cacheWrite1h":0},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "DoubaoSeed",
  ...
  officialRate({
    ...
    model: "kimi-k3",
    aliases: ["kimi-k3"],
    input: 2.9693327315485663,
    cachedInput: 0.2969332731548566,
    cacheWrite5m: 2.9693327315485663,
    cacheWrite1h: 2.9693327315485663,
    output: 14.846663657742832,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":20,"cachedInput":2,"cacheWrite5m":20,"cacheWrite1h":20,"output":100},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
  ...
  officialRate({
    ...
    input: 0.965033137753284,
    cachedInput: 0.1930066275506568,
    cacheWrite5m: 0.965033137753284,
    cacheWrite1h: 0.965033137753284,
    output: 4.008599187590565,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.3,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.930066275506568,
    cachedInput: 0.3860132551013136,
    cacheWrite5m: 1.930066275506568,
    cacheWrite1h: 1.930066275506568,
    output: 8.01719837518113,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":13,"cachedInput":2.6,"cacheWrite5m":13,"cacheWrite1h":13,"output":54},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-6"],
    input: 0.965033137753284,
    cachedInput: 0.16331330023517115,
    cacheWrite5m: 0.965033137753284,
    cacheWrite1h: 0.965033137753284,
    output: 4.008599187590565,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":6.5,"cachedInput":1.1,"cacheWrite5m":6.5,"cacheWrite1h":6.5,"output":27},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    aliases: ["kimi-k2-5"],
    input: 0.5938665463097133,
    cachedInput: 0.10392664560419981,
    cacheWrite5m: 0.5938665463097133,
    cacheWrite1h: 0.5938665463097133,
    output: 3.117799368125995,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"cachedInput":0.7,"cacheWrite5m":4,"cacheWrite1h":4,"output":21},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Kimi",
    note: "Official Kimi API CNY rate parsed from the current model pricing pages."
  }),
  officialRate({
    ...
    input: 1.7815996389291398,
    cachedInput: 1.7815996389291398,
    cacheWrite5m: 1.7815996389291398,
    cacheWrite1h: 1.7815996389291398,
    output: 5.344798916787419,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":12,"output":36,"cachedInput":12,"cacheWrite5m":12,"cacheWrite1h":12},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB prices converted to USD for internal cost math; short-context public rates are used by default."
  }),
  officialRate({
    ...
    cacheWrite1h: 0.2969332731548566,
    output: 1.1877330926194265,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":8,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    input: 0.17815996389291397,
    cachedInput: 0.17815996389291397,
    cacheWrite5m: 0.17815996389291397,
    cacheWrite1h: 0.17815996389291397,
    output: 1.068959783357484,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1.2,"output":7.2,"cachedInput":1.2,"cacheWrite5m":1.2,"cacheWrite1h":1.2},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5938665463097133,
    cachedInput: 0.5938665463097133,
    cacheWrite5m: 0.5938665463097133,
    cacheWrite1h: 0.5938665463097133,
    output: 2.375466185238853,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":4,"output":16,"cachedInput":4,"cacheWrite5m":4,"cacheWrite1h":4},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite1h: 0.1484666365774283,
    output: 0.5938665463097133,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":1,"output":4,"cachedInput":1,"cacheWrite5m":1,"cacheWrite1h":1},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB short-context Coder rate converted to USD at the last verified refresh rate."
  }),
  officialRate({
    ...
    input: 0.5196332280209991,
    cachedInput: 0.5196332280209991,
    cacheWrite5m: 0.5196332280209991,
    cacheWrite1h: 0.5196332280209991,
    output: 1.0392664560419982,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":3.5,"output":7,"cachedInput":3.5,"cacheWrite5m":3.5,"cacheWrite1h":3.5},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
  ...
  officialRate({
    ...
    cacheWrite5m: 0.2969332731548566,
    cacheWrite1h: 0.2969332731548566,
    output: 0.8907998194645699,
    officialRatesPerMTok: {"currency":"CNY","unit":"1M tokens","ratesPerMTok":{"input":2,"output":6,"cachedInput":2,"cacheWrite5m":2,"cacheWrite1h":2},"exchangeRate":6.73552,"sourceUnit":"元 / 1M tokens"},
    source: "Qwen",
    note: "Official Alibaba Cloud Model Studio RMB Coder rate converted to USD at the last verified refresh rate."
  })
];
