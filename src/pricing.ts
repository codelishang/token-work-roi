...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    input: 1.1772863784434155,
    cachedInput: 0.2943215946108539,
    cacheWrite5m: 1.1772863784434155,
    cacheWrite1h: 1.1772863784434155,
    output: 4.120502324551954,
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.8829647838325616,
    cachedInput: 0.19130903649705502,
    cacheWrite5m: 0.8829647838325616,
    cacheWrite1h: 0.8829647838325616,
    output: 3.5318591353302464,
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.11772863784434155,
    cachedInput: 0.02354572756886831,
    cacheWrite5m: 0.11772863784434155,
    cacheWrite1h: 0.11772863784434155,
    output: 0.2943215946108539,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    input: 0.2943215946108539,
    cachedInput: 0.058864318922170776,
    cacheWrite5m: 0.2943215946108539,
    cacheWrite1h: 0.2943215946108539,
    output: 1.1772863784434155,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5886431892217078,
    cachedInput: 0.14716079730542694,
    cacheWrite5m: 0.5886431892217078,
    cacheWrite1h: 0.5886431892217078,
    output: 2.6488943514976846,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7358039865271346,
    cachedInput: 0.17659295676651232,
    cacheWrite5m: 0.7358039865271346,
    cacheWrite1h: 0.7358039865271346,
    output: 3.2375375407193925,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
