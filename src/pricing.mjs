...
export const OFFICIAL_PRICE_TABLE = [
  ...
  officialRate({
    ...
    input: 1.1745429559722573,
    cachedInput: 0.29363573899306433,
    cacheWrite5m: 1.1745429559722573,
    cacheWrite1h: 1.1745429559722573,
    output: 4.1109003459029,
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.8809072169791929,
    cachedInput: 0.19086323034549182,
    cacheWrite5m: 0.8809072169791929,
    cacheWrite1h: 0.8809072169791929,
    output: 3.5236288679167718,
    source: "Zhipu GLM",
  ...
  officialRate({
    ...
    input: 0.11745429559722573,
    cachedInput: 0.023490859119445148,
    cacheWrite5m: 0.11745429559722573,
    cacheWrite1h: 0.11745429559722573,
    output: 0.29363573899306433,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    input: 0.29363573899306433,
    cachedInput: 0.058727147798612864,
    cacheWrite5m: 0.29363573899306433,
    cacheWrite1h: 0.29363573899306433,
    output: 1.1745429559722573,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5",
    aliases: ["glm-5"],
    input: 0.5872714779861287,
    cachedInput: 0.14681786949653217,
    cacheWrite5m: 0.5872714779861287,
    cacheWrite1h: 0.5872714779861287,
    output: 2.642721650937579,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
    ...
    model: "glm-5-turbo",
    aliases: ["glm-5-turbo"],
    input: 0.7340893474826607,
    cachedInput: 0.17618144339583858,
    cacheWrite5m: 0.7340893474826607,
    cacheWrite1h: 0.7340893474826607,
    output: 3.2299931289237076,
    source: "Zhipu GLM",
    note: "Official BigModel pricing page. RMB prices are converted to USD for internal cost math."
  }),
  officialRate({
