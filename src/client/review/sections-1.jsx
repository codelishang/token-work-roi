  ...
  return (
    <section className="hero">
      ...
      <p className="hero-sub">
        官方价换算 <b style={{color: 'var(--ink)', fontVariantNumeric: 'tabular-nums'}}>{U.money(totals.cost)}</b>
        {delta != null && (
          <>
            ，比上一周期
      ...
      <div className="stat-strip">
        ...
        <div className="stat-cell">
          ...
          <div className="v">{U.money(stats.avgDailyCost)}</div>
          <div className="s">{stats.activeDays} 天 / {U.money(totals.cost)}</div>
        </div>
      </div>
    </section>
  );
...
function ProjectSection({ daily, totalTokens }) {
  ...
  return (
    <section className="story">
      <div className="section-label">04 · 项目</div>
          ...
          return (
            <div key={p.key} className="proj-row">
              ...
              <div className="proj-val">
                ...
                <div className="small">{p.costUSD > 0 ? U.money(p.costUSD) : '—'}</div>
              </div>
            </div>
          );
        })}
...
function CalendarSection({ daily, period }) {
  ...
  return (
    <section className="story">
      <div className="section-label">05 · 时间线</div>
